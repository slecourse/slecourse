...
public class MicroJavaParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("MicroJava");
  ...
  { 
    MicroJavaParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = MicroJavaParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = MicroJavaParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(MicroJavaParseControllerGenerated.class);
    }
  ...
  { 
    return MicroJavaParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
